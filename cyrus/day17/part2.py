# Advent of Code 2020 Day 17 Part 2 solution
# Cyrus Sadeghi
        ...
        for y in range(-1, 2):
            for z in range(-1, 2):
                for w in range(-1, 2):
                    ...
                    neighbours.append((coord[0] + x, coord[1] + y, coord[2] + z, coord[3] + w))
...
def main():
    ...
    # can be optimized by replacing nested loops with set operations (this works but is slow)
    while cycle != 6:
        neighbour_occ = dict()
