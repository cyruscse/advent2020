...
def main():
   ...
   for i in puzzle_input:
       ...
       collectionSeats.append(seatID)    

   collectionSeats.sort()   
   minSeatID = collectionSeats[0]
   maxSeatID = collectionSeats[len(collectionSeats)-1]
   yourSeatID = 0

   for i in range(minSeatID,maxSeatID):
       if i not in collectionSeats:
           yourSeatID = i


#   print("Min Seat ID: " + str(minSeatID) + ", Highest Seat ID: " + str(maxSeatID))
#   print(collectionSeats)
   print("Your Seat ID: " + str(yourSeatID))
